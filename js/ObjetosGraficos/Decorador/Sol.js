...
Sol.prototype.dibujar = function(){
  ...
  mvPushMatrix();
    ...
    mat4.translate(translate_sol, translate_sol, [DISTANCIAXSOL, DISTANCIAYTIERRA, 0 ]);
    ...
    mat4.rotate(translation_movement, translation_movement, this.solRotationAngletierra, [1, 0, 0]);
